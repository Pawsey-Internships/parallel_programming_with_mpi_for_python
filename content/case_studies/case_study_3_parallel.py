...
if size < 2:
    print('This program requires more than one MPI process!')
    exit()
...
if num_points % size != 0:
    print('The number of MPI processes must be a divisor of "num_points"!')
    exit()
...
while num_iter <  max_iter:
    ...
    if rank==0:
        ...
        # Uncomment to visualise the game.
        image = Image.fromarray(np.uint8(sol*255))
        images.append(image)
...
# Uncomment lines 229 and 230 to create an animation of the game of life.
if (rank == 0) and (len(images) > 1):
